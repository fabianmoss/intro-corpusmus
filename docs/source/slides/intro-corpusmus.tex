...
\definecolor{colognedark}{RGB}{43,90,112}
...
\institute{Musikwissenschaftliches Seminar \textcolor{cologneblue}{\textbf{//}} Universität zu Köln \textcolor{cologneblue}{\textbf{//}} WS 2020/21}
...
\input{0_intro.tex}
\input{1_what_are_MCS.tex}
\input{3_examples.tex}
\input{4_course_organization.tex}
